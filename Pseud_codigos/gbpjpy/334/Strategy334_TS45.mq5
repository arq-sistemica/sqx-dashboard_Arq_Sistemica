//+------------------------------------------------------------------+
//| Strategy 3.3.4 - Improved 5.1.5 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (hedged)
//|    Generated at 05/24/2026 00:38
//| 
//|    Backtested on GBPJPY_Data_M1_ESTPlus07 / H1, 2006.01.01 - 2026.01.15 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_3_3_4_Improved_5_1_5";
...
input int ExitAfterBars1 = 15;        //ExitAfterBars1
input double StopLossCoef1 = 3;        //StopLossCoef1
input double TrailingStopPips = 45;    //TrailingStopPips (0 = disabled)
...
input string SignalTimeRangeFrom = "01:30";
input string SignalTimeRangeTo = "23:30";
...
#define PARABOLICSAR_1 0     //iCustom(NULL,0, "SqParabolicSAR", 0.010, 0.20)
#define PIVOTS_1 1     //iCustom(NULL,0, "SqPivots", 0, 0)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 45)
...
string sqStrategyName = "Strategy 3.3.4 - Improved 5.1.5";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsLowerCount("sqGetIndicatorValue(PARABOLICSAR_1, 0, 1)","sqGetIndicatorValue(PIVOTS_1, 4, 1)",6,true,1));
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         if(TrailingStopPips > 0) {
            sqSetTrailingStop(_ticket, "sqConvertToRealPips(valueIdentificationSymbol, TrailingStopPips)", SLPTTYPE_RANGE);
         }
      }
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PIVOTS_1] = iCustom(NULL,0, "SqPivots", 0, 0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 45);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("sqConvertToRealPips(valueIdentificationSymbol, TrailingStopPips)")) {
      return sqConvertToRealPips(valueIdentificationSymbol, TrailingStopPips);
   }
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(PARABOLICSAR_1, 0, 1)") {
          return sqGetIndicatorValue(PARABOLICSAR_1, 0, shift + 1);
      }
      if(id == "sqGetIndicatorValue(PIVOTS_1, 4, 1)") {
          return sqGetIndicatorValue(PIVOTS_1, 4, shift + 1);
      }
